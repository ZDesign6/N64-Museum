...
namespace P64::Script::CA40988B0B39ED89
{
  P64_DATA(
  ...
  void draw(Object& obj, Data *data, float deltaTime)
  {
      ...
      //update the Player's Rot by getting the Player Obj off the Player ObjRef off of data, then deref its rot
      data->playerRot = data->playerObj.get()->rot;
      Debug::print(100, 100, "test");
  }
