...
namespace P64::Script::C80474DD848455A5
{
  P64_DATA(
  ...
  void onCollision(Object& obj, Data *data, const Coll::CollEvent& event)
  {
    // collision callbacks, only used if any collider is attached
        ...
        //Get Character Body component off the object and teleport it to editor-set location
      //event.otherObject->getComponent<P64::Comp::CharBody>()->getBody().teleport({ 0, 100, 0 });
      //body.teleport({0, 100, 0});
        //otherObject.getComponent<P64::Comp::CharBody>()
            //call teleport to inspector-set location
  }
}
